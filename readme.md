...
1. Partner 1: [Ramya](https://github.com/RamyaKammari) <-change to you or your partner
2. Partner 2: [Vikram](https://github.com/vikramsaix) <-change to you or your partner
3. Partner 3: [Abhishek](https://github.com/abhishek-07)
...
5. "npx playwright test" <- Run the playwright testss
